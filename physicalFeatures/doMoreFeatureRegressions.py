...
with open('protein_featuresSt.csv', newline='') as f:
    reader = csv.reader(f)
    counter = 0
    for row in reader:
        if counter > 0:
...
features3 = []
with open('protein_features2St.csv', newline='') as f:
    reader = csv.reader(f)
    counter = 0
    for row in reader:
        if counter > 0:
...
with open('pfeatureLosses1St.csv', 'w', newline='') as f:
    seed = 42
    writer = csv.writer(f)
    ...
    for ls in labelSplits:
        ...
        labelCounter += 1
with open('pfeatureLosses2St.csv', 'w', newline='') as f:
    seed = 43
    writer = csv.writer(f)
    header = ['Normlaization', 'Regressing out', 'Points', 'Feature Selection', 'Regression Type', 'Test Split', 'Test R2 Score', 'RMSE Score']
    writer.writerow(header)
...
with open('pfeatureLosses3St.csv', 'w', newline='') as f:
    seed = 44
    writer = csv.writer(f)
    header = ['Normlaization', 'Regressing out', 'Points', 'Feature Selection', 'Regression Type', 'Test Split', 'Test R2 Score', 'RMSE Score']
    writer.writerow(header)
...
with open('pfeatureLosses4St.csv', 'w', newline='') as f:
    seed = 45
    writer = csv.writer(f)
    header = ['Normlaization', 'Regressing out', 'Points', 'Feature Selection', 'Regression Type', 'Test Split', 'Test R2 Score', 'RMSE Score']
    writer.writerow(header)
...
with open('pfeatureLosses5St.csv', 'w', newline='') as f:
    seed = 46
    writer = csv.writer(f)
    header = ['Normlaization', 'Regressing out', 'Points', 'Feature Selection', 'Regression Type', 'Test Split', 'Test R2 Score', 'RMSE Score']
    writer.writerow(header)
