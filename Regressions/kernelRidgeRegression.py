...
def krr(inpath, test_size, emb_col, rg_col="Rg (nm)", alphas=[1e-2, 1e-1, 1, 10], gammas=[1e-3, 1e-2, 1e-1, 1], outpath=None):
...
if __name__ == "__main__":
    ...
    krr(inpath, test_size, emb_col, rg_col, alphas, gammas)